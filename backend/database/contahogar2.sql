...
CREATE TABLE IF NOT EXISTS `contahogar2`.`deudas` (
  ...
  `nomDeuda` VARCHAR(45) NULL DEFAULT NULL,
  `totalDeuda` VARCHAR(45) NULL DEFAULT NULL,
  `restoDeuda` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idDeuda`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `contahogar2`.`movimientos` (
  ...
  `comentarioMovimiento` VARCHAR(250) CHARACTER SET 'utf8mb3' NULL DEFAULT NULL,
